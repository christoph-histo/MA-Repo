...
def setup(mode="train", augmentation="no_aug"):
    ...
    encoder_path = "/home/christoph/Dokumente/christoph-MA//research-contributions/swin_unetr.base_5000ep_f48_lr2e-4_pretrained.pt"
    ...
    save_path = f'/home/christoph/Dokumente/christoph-MA/Models/SwinUNETR_Aggregator_3D_organ_classification_patches_{augmentation}.pth'
