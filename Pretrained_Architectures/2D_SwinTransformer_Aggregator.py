...
def train():
    ...
    torch.save(model.state_dict(), '/home/christoph/Dokumente/christoph-MA/Models/SwinTransformer_Aggregator_2D_organ_classification_patches_no_aug.pth')

def eval():
    
    global model

    model_path = '/home/christoph/Dokumente/christoph-MA/Models/SwinTransformer_Aggregator_2D_organ_classification_patches_no_aug.pth'
