...
def train(data_path, model, save_path, device, augmentation):
    ...
    dataset = Dataloader_patches.VolumeToPatchesDataset(root_dir=data_path, transform=None, num_channels=3, test=False, augmentation=augmentation)
...
def eval(data_path, model, model_path, device):
    ...
    dataset = Dataloader_patches.VolumeToPatchesDataset(root_dir=data_path, transform=None, num_channels=3, test=True)
